                        ...
                        <tr key={apt.id} className="border-b border-gray-200 last:border-b-0 hover:bg-gray-50/50 transition-colors">
                            <td className="p-4">
                                <div className="flex items-center">
                                    <img src={apt.patient.avatar_url ?? ''} alt={apt.patient.name} className="w-10 h-10 rounded-full mr-3" />
                            ...
                            <td className="p-4">
                                <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(apt.status as AppointmentStatus)}`}>
                                    {apt.status}
                                </span>
                            </td>
                        </tr>
